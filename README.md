...
To deploy a cluster with enabled [RBAC](https://docs.mesosphere.com/services/kubernetes/2.2.0-1.13.2/operations/authn-and-authz/#rbac) update `.deploy/options.json`:
...
If you want to give users access to the Kubernetes API check [documentation](https://docs.mesosphere.com/services/kubernetes/2.2.0-1.13.2/operations/authn-and-authz/#giving-users-access-to-the-kubernetes-api).
...
Please note that you will have to sign-in into the [Kubernetes Dashboard](https://docs.mesosphere.com/services/kubernetes/2.2.0-1.13.2/operations/kubernetes-dashboard/#login-view-and-authorization) before being able to perform any action.
...
For more details, please see the [docs folder](docs) and as well check the official [service docs](https://docs.mesosphere.com/service-docs/kubernetes/2.2.0-1.13.2)
