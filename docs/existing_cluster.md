...
Before proceeding, make sure your cluster fulfils the [Kubernetes package default requirements](https://docs.mesosphere.com/services/kubernetes/2.2.0-1.13.2/getting-started/install-basic/#prerequisites).
